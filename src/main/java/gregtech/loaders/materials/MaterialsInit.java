...
public class MaterialsInit {
    ...
    // region Infinity Rework Materials

    private static void loadInfinityReworkMaterials() {
        Materials.Moebianite = loadMoebianite();
        Materials.Manifold = loadManifold();
        Materials.MoebianiteSlag = loadMoebianiteSlag();
        Materials.MoebianiteCrystalSlurry = loadMoebianiteCrystalSlurry();
        Materials.PurifiedMoebianite = loadPurifiedMoebianite();
        Materials.NonOrientableMatter = loadNonOrientableMatter();
        Materials.InertTaranium = loadInertTaranium();
        Materials.HighlyReactiveTaranium = loadHighlyReactiveTaranium();
        Materials.HighlyStableTaranium = loadHighlyStableTaranium();
        Materials.QuanticalDisturbance = loadQuanticalDisturbance();
        Materials.ParastableFractalHelium = loadParastableFractalHelium();
        Materials.FractalHeliumBoseEinsteinCondensate = loadFractalHeliumBoseEinsteinCondensate();
        Materials.Fractal = loadFractal();
        Materials.FractalJuice = loadFractalJuice();
        Materials.Cardinality = loadCardinality();
        Materials.Causality = loadCausality();
        Materials.Chirality = loadChirality();
    }

    private static Materials loadMoebianite() {
        return new MaterialBuilder().setName("Moebianite")
            .setDefaultLocalName("Möebianite")
            .setFlavorText("A material that seems to defy crystallographic rules")
            .setIconSet(TextureSet.SET_LIGNITE)
            .setColor(Dyes.dyeBrown)
            .setARGB(0x003a1a0d)
            .addDustItems()
    ...
    private static Materials loadManifold() {
        return new MaterialBuilder().setName("Manifold")
            .setDefaultLocalName("Manifolder")
            .setIconSet(TextureSet.SET_GEM_HORIZONTAL)
            .setColor(Dyes.dyeBrown)
            .setARGB(0x64fd6c2b)
            .addDustItems()
    ...
    private static Materials loadMoebianiteSlag() {
        return new MaterialBuilder().setName("MoebianiteSlag")
            .setDefaultLocalName("Crude Möebianite Slag")
            .setIconSet(TextureSet.SET_FLUID)
            .setARGB(0x003a1a0d)
            .addCell()
            .addFluid()
    ...
    private static Materials loadMoebianiteCrystalSlurry() {
        return new MaterialBuilder().setName("MoebianiteCrystalSlurry")
            .setDefaultLocalName("Möebianite Crystal Slurry")
            .setIconSet(TextureSet.SET_FLUID)
            .setARGB(0x00a04a21)
            .addCell()
            .addFluid()
    ...
    private static Materials loadPurifiedMoebianite() {
        return new MaterialBuilder().setName("PurifiedMoebianite")
            .setDefaultLocalName("Purified Möebianite")
            .setIconSet(TextureSet.SET_FLUID)
            .setARGB(0x00fee28b)
            .addCell()
            .addFluid()
    ...
    private static Materials loadNonOrientableMatter() {
        return new MaterialBuilder().setName("NonOrientableMatter")
            .setDefaultLocalName("Non-Orientable Matter")
            .setFlavorText("Can this be called matter?")
            .setIconSet(TextureSet.SET_FIERY)
            .setARGB(0x003a1a0d)
            .addCell()
            .addFluid()
    ...
    private static Materials loadInertTaranium() {
        return new MaterialBuilder().setName("InertTaranium")
            .setDefaultLocalName("Inert Taranium")
            .setIconSet(TextureSet.SET_DULL)
            .setColor(Dyes.dyeBlue)
            .setARGB(0x645e607e)
            .addDustItems()
    ...
    private static Materials loadHighlyReactiveTaranium() {
        return new MaterialBuilder().setName("HighlyReactiveTaranium")
            .setDefaultLocalName("Highly Reactive Taranium")
            .setIconSet(TextureSet.SET_NETHERSTAR)
            .setColor(Dyes.dyeBlue)
            .setARGB(0x64be0db5)
            .addDustItems()
    ...
    private static Materials loadHighlyStableTaranium() {
        return new MaterialBuilder().setName("HighlyStableTaranium")
            .setDefaultLocalName("Highly Stable Taranium")
            .setIconSet(TextureSet.SET_SHINY)
            .setColor(Dyes.dyeBlue)
            .setARGB(0x641264ff)
            .addDustItems()
    ...
    private static Materials loadQuanticalDisturbance() {
        return new MaterialBuilder().setName("QuanticalDisturbance")
            .setDefaultLocalName("Quantically Disturbed Anomalous")
            .setIconSet(new TextureSet("quanticalDisturbance", true))
            .setARGB(0x00ffaac8)
            .addDustItems()
            .setAutoGenerateBlastFurnaceRecipes(false)
            .setAutoGeneratedVacuumFreezerRecipe(false)
            .addAspect(TCAspects.SENSUS, 150)
            .constructMaterial();
    }

    private static Materials loadParastableFractalHelium() {
        return new MaterialBuilder().setName("ParastableFractalHelium")
            .setDefaultLocalName("Parastable Fractal Helium")
            .setIconSet(TextureSet.SET_FLUID)
            .setARGB(0x00395941)
            .addCell()
            .addFluid()
            .addSubTag(SubTag.TRANSPARENT)
            .constructMaterial()
            .setLiquidTemperature(6969);
    }

    private static Materials loadFractalHeliumBoseEinsteinCondensate() {
        return new MaterialBuilder().setName("FractalHeliumBoseEinsteinCondensate")
            .setDefaultLocalName("Fractal Helium Bose-Einstein Condensate")
            .setIconSet(TextureSet.SET_FLUID)
            .setARGB(0x005415bd)
            .addCell()
            .addFluid()
    ...
    private static Materials loadFractal() {
        return new MaterialBuilder().setName("Fractal")
            .setDefaultLocalName("Fractal")
            .setIconSet(new TextureSet("fractal", true))
            .setARGB(0x00000000)
            .addDustItems()
            .addGemItems()
            .setAutoGenerateBlastFurnaceRecipes(false)
    ...
    private static Materials loadFractalJuice() {
        return new MaterialBuilder().setName("FractalJuice")
            .setDefaultLocalName("Fractal Juice")
            .setIconSet(TextureSet.SET_FLUID)
            .setARGB(0x00bcdd09)
            .addCell()
            .addFluid()
    ...
    private static Materials loadCardinality() {
        return new MaterialBuilder().setName("Cardinality")
            .setDefaultLocalName("Cardinality")
            .setIconSet(TextureSet.SET_FLUID)
            .setARGB(0x00ff0000)
            .addCell()
            .addFluid()
    ...
    private static Materials loadCausality() {
        return new MaterialBuilder().setName("Causality")
            .setDefaultLocalName("Causality")
            .setIconSet(TextureSet.SET_FLUID)
            .setARGB(0x0000ff00)
            .addCell()
            .addFluid()
    ...
    private static Materials loadChirality() {
        return new MaterialBuilder().setName("Chirality")
            .setDefaultLocalName("Chirality")
            .setIconSet(TextureSet.SET_FLUID)
            .setARGB(0x000000ff)
            .addCell()
            .addFluid()
