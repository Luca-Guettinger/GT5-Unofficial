...
public enum MetaTileEntityIDs {
    ...
    CANNER_EV(234),
    CANNER_IV(235),
    COKE_OVEN_CONTROLLER(236),
    COKE_OVEN_HATCH(237),
    DEBUG_FLUID_TANK(238),
    COMPRESSOR_LV(241),
    COMPRESSOR_MV(242),
    COMPRESSOR_HV(243),
    COMPRESSOR_EV(244),
    ...
    CENTRIFUGE_EV(364),
    CENTRIFUGE_IV(365),
    MULTI_FLUID_SHAPER_CONTROLLER(366),
    SOLAR_FACTORY_CONTROLLER(367),
    MULTI_MASS_SOLIDIFIER_CONTROLLER(368),
    ELECTROLYSER_LV(371),
    ELECTROLYSER_MV(372),
    ELECTROLYSER_HV(373),
    ELECTROLYSER_EV(374),
    ...
    INPUT_HATCH_ME(2717),
    INPUT_BUS_ME(2718),
    INPUT_BUS_PATTERN_PROVIDER(2719),
    ...
    HATCH_BLACK_HOLE_UTILITY(3012),
    LARGE_HADRON_COLLIDER(3013),
    HATCH_ADVANCED_BEAMLINE_OUTPUT(3014),
    BEAM_CRAFTER(3015),
    BEAM_MIRROR(3016),
    BEAM_SPLITTER(3017),
    ...
    NANOCHIP_MODULE_SUPERCONDUCTOR_SPLITTER(9511),
    NANOCHIP_MODULE_OPTICAL_ORGANIZER(9512),
    NANOCHIP_MODULE_ENCASEMENT_WRAPPER(9513),
    NANOCHIP_MODULE_BIOLOGICAL_COORDINATOR(9514),
    HATCH_SPLITTER_LEVEL(9515),
    ...
    ENERGY_HATCH_DEBUG(11304),
    INPUT_BUS_DEBUG(11305),
    INPUT_HATCH_DEBUG(11306),
    ...
    LegacyMegaBlastFurnace(12730),
    LegacyMegaVacuumFreezer(12731),
    MultiNqGenerator(12732),
    ThoriumHighTemperatureReactor(12733),
    LegacyElectricImplosionCompressor(12734),
    CircuitAssemblyLine(12735),
    CompressedFluidHatch(12736),
    GiantOutputHatch(12737),
    LegacyMegaDistillationTower(12738),
    VoidMinerIII(12739),
    VoidMinerII(12740),
    VoidMinerI(12741),
    AcidGeneratorIV(12742),
    ...
    LegacyMegaChemicalReactor(13366),
    ...
    GasTurbineXL(15522),
    PlasmaTurbineXL(15523),
    SteamTurbine(15524),
    HPSteamTurbine(15525),
    SCSteamTurbine(15526),
    GasTurbine(15527),
    PlasmaTurbine(15528),
    BronzeBoilerLarge(15529),
    SteelBoilerLarge(15530),
    TitaniumBoilerLarge(15531),
    TungstensteelBoilerLarge(15532),
    LargeCombustionEngine(15533),
    ExtremeCombustionEngine(15534),
    ...
    IndustrialMaterialPress(15552),
    IndustrialBendingMachine(15553),
    IndustrialPrinter(15554),
    IndustrialForgeHammer(15555),
    Boldarnator(15556),
    ThermalBoiler(15557),
    ...
    ChiselBus_MV(31779),
    ChiselBus_HV(31780),
    Hatch_Solidifier_I(31781),
    Hatch_Solidifier_II(31782),
    Hatch_Solidifier_III(31783),
    Hatch_Solidifier_IV(31784),
    Hatch_Extrusion_I(31785),
    Hatch_Extrusion_II(31786),
    Hatch_Extrusion_III(31787),
    Hatch_Extrusion_IV(31788),
    ...
    LegacyUniversalChemicalFuelEngine(32001),
