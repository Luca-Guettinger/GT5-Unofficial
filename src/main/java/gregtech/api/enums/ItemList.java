...
public enum ItemList implements IItemContainer {
    ...
    CircuitImprint_EnhancedCircuitBoard,
    CircuitImprint_ElectronicCircuit,
    CircuitImprint_RefinedCircuitBoard,
    CircuitImprint_AdvancedCircuit,
    CircuitImprint_IntricateCircuitBoard,
    CircuitImprint_QuantumAssembly,
    CircuitImprint_NANDChipArray,
    CircuitImprint_QuantumSupercomputer,
    CircuitImprint_IntegratedProcessor,
    CircuitImprint_CrystalSupercomputer,
    CircuitImprint_OpticalProcessor,
    CircuitImprint_CrystalMainframe,
    CircuitImprint_NanoSupercomputer,
    CircuitImprint_QuantumProcessor,
    CircuitImprint_WetwareSupercomputer,
    CircuitImprint_QuantumMainframe,
    CircuitImprint_CrystalProcessor,
    CircuitImprint_WetwareProcessor,
    CircuitImprint_WetwareAssembly,
    CircuitImprint_Workstation,
    CircuitImprint_Mainframe,
    CircuitImprint_NanoMainframe,
    CircuitImprint_Microprocessor,
    CircuitImprint_GoodIntegratedCircuit,
    CircuitImprint_HighEnergyFlowCircuit,
    CircuitImprint_ControllerCircuit,
    CircuitImprint_SignalCircuit,
    CircuitImprint_ReceiverCircuit,
    CircuitImprint_BiowareAssembly,
    CircuitImprint_IntegratedLogicCircuit,
    CircuitImprint_GoodElectronicCircuit,
    CircuitImprint_ProcessorAssembly,
    CircuitImprint_CrystalAssembly,
    CircuitImprint_BiowareProcessor,

    SlicedCircuit_NanoProcessor,
    SlicedCircuit_BasicCircuitBoard,
    SlicedCircuit_NanoAssembly,
    SlicedCircuit_EnhancedCircuitBoard,
    SlicedCircuit_ElectronicCircuit,
    SlicedCircuit_RefinedCircuitBoard,
    SlicedCircuit_AdvancedCircuit,
    SlicedCircuit_IntricateCircuitBoard,
    SlicedCircuit_QuantumAssembly,
    SlicedCircuit_NANDChipArray,
    SlicedCircuit_QuantumSupercomputer,
    SlicedCircuit_IntegratedProcessor,
    SlicedCircuit_CrystalSupercomputer,
    SlicedCircuit_OpticalProcessor,
    SlicedCircuit_CrystalMainframe,
    SlicedCircuit_NanoSupercomputer,
    SlicedCircuit_QuantumProcessor,
    SlicedCircuit_WetwareSupercomputer,
    SlicedCircuit_QuantumMainframe,
    SlicedCircuit_CrystalProcessor,
    SlicedCircuit_WetwareProcessor,
    SlicedCircuit_WetwareAssembly,
    SlicedCircuit_Workstation,
    SlicedCircuit_Mainframe,
    SlicedCircuit_NanoMainframe,
    SlicedCircuit_Microprocessor,
    SlicedCircuit_GoodIntegratedCircuit,
    SlicedCircuit_HighEnergyFlowCircuit,
    SlicedCircuit_ControllerCircuit,
    SlicedCircuit_SignalCircuit,
    SlicedCircuit_ReceiverCircuit,
    SlicedCircuit_BiowareAssembly,
    SlicedCircuit_IntegratedLogicCircuit,
    SlicedCircuit_GoodElectronicCircuit,
    SlicedCircuit_ProcessorAssembly,
    SlicedCircuit_CrystalAssembly,
    SlicedCircuit_BiowareProcessor,

    Wrap_EngravedCrystalChips,
    Wrap_EngravedLapotrionChips,
    Wrap_CoatedCircuitBoards,
    Wrap_CircuitBoards,
    Wrap_PhenolicCircuitBoards,
    Wrap_GoodCircuitBoards,
    Wrap_EpoxyCircuitBoards,
    Wrap_AdvancedCircuitBoards,
    Wrap_FiberReinforcedCircuitBoards,
    Wrap_MoreAdvancedCircuitBoards,
    Wrap_EliteCircuitBoards,
    Wrap_MultilayerFiberReinforcedCircuitBoards,
    Wrap_WetwareLifesupportCircuitBoards,
    Wrap_ExtremeWetwareLifesupportCircuitBoards,
    ...
    Wrap_SMDTransistors,
    Wrap_SMDCapacitors,
    Wrap_AdvancedSMDResistors,
    Wrap_AdvancedSMDDiodes,
    Wrap_AdvancedSMDTransistors,
    Wrap_AdvancedSMDCapacitors,
    Wrap_IntegratedLogicCircuits,
    Wrap_RandomAccessMemoryChips,
    Wrap_NANDMemoryChips,
    Wrap_NORMemoryChips,
    Wrap_CentralProcessingUnits,
    Wrap_SoCs,
    Wrap_ASoCs,
    Wrap_PowerICs,
    Wrap_SimpleSOCs,
    Wrap_HighPowerICs,
    Wrap_UltraHighPowerICs,
    Wrap_UltraLowPowerICs,
    Wrap_LowPowerICs,
    Wrap_NanoPowerICs,
    Wrap_PikoPowerICs,
    Wrap_QuantumPowerICs,
    Wrap_NanocomponentCentralProcessingUnits,
    Wrap_QBitProcessingUnits,
    Wrap_CrystalProcessingUnits,
    Wrap_CrystalSoCs,
    Wrap_RawAdvancedCrystalChips,
    Wrap_NeuroProcessingUnits,
    Wrap_BioProcessingUnits,
    Wrap_Stemcells,
    Wrap_Biocells,
    Wrap_OpticalSMDResistors,
    Wrap_OpticalSMDDiodes,
    Wrap_OpticalSMDTransistors,
    Wrap_OpticalSMDCapacitors,
    Wrap_AdvancedSMDInductors,
    Wrap_OpticalSMDInductors,
    Wrap_RawExposedOpticalChips,
    Wrap_OpticalCircuitBoards,
    Wrap_OpticallyPerfectedCPUs,
